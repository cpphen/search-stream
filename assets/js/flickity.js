...
var flick = $('<div class = "main-carousel" data-flickity style = "border: solid; border-color: black; border-width: 10px; background-color: #333333; padding: 20px; height: 470px">');

for (var x = 0; x < 10; x++)
{
	var cellDiv = $('<div class = "carousel-cell" style = "height: 470px  ; width: 500px">');
  var cellImage = $('<img class = "carousel-image" style = "padding: 10px; height: 100%; width: 100%" src =' + flickityImages[x]+ '>')
